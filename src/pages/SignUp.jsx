...
const SignUp = ({ apiCall }) => {
  ...
  const checkInvalidInput = (approved) =>{
    if(firstname.trim() === '' || lastname.trim() === '' || email.trim() === '' || password.trim() === '' || conPassword.trim() === ''){
      setHasErrors(true)
      alert("Make sure all fields have been inputted");
      ...
      apiCall(
          ...
          (r) => {
            ...
            if(r.errors.length === 0){
              alert("Student verification sent to email!");
              navigate("/");
            }
          },
          (e) => {
    ...
    <div className="w-full h-screen flex flex-col items-center ">
      <div className="w-[90%] md:w-[50%] lg:w-[40%] xl:w-[30%] h-full flex flex-col items-center gap-4">
        ...
        <form className="w-[80%] flex-grow flex flex-col gap-2 md:gap-[1.5vmin] pt-[1vmax]">
          ...
          <div className={`flex gap-2 items-center rounded-full ${hasErrors ? 'bg-red-500':'bg-slate-100'} p-2 md:p-[0.5vmax] pl-4`}>
          ...
          <div className={`flex gap-2 rounded-full ${hasErrors ? 'bg-red-500':'bg-slate-100'} p-2 md:p-[0.5vmax] pl-4`}>
          ...
          <div className={`flex gap-2 items-center rounded-full ${hasErrors ? 'bg-red-500':'bg-slate-100'} p-2 md:p-[0.5vmax]  px-4`}>
